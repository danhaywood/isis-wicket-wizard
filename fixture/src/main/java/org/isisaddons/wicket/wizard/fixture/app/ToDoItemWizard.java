...
import org.isisaddons.wicket.wizard.fixture.dom.WizardWicketToDoItems;
...
public class ToDoItemWizard
    ...
    //region > viewModel implementation, wizard impl
    @Override
    ...
    private WizardWicketToDoItem.Subcategory subcategory;

    @Disabled(reason = "Use the update action to change both category and subcategory")
    @Optional
    public WizardWicketToDoItem.Subcategory getSubcategory() {
        return subcategory;
    }
    public void setSubcategory(final WizardWicketToDoItem.Subcategory subcategory) {
    ...
    public WizardWicketToDoItem.Subcategory getSubcategoryOnSummary() {
    ...
    public WizardWicketToDoItem finish() {
